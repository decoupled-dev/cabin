...
### Views Button / IconButton / ListItem (post-MVP Alpha)

- Robolectric: bind + Restriction Engine allow / substitute / block
- Fail-closed when compliance host is null
- Touch / cabin-density minima from component tokens
- IconButton contentDescription required
...
| Compose Button / ListItem | **Experimental** — gate / density parity tests in `cabin-compose` (shipped); screenshot later |
