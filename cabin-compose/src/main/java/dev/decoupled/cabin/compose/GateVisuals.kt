...
/**
 * Shared Restriction Engine visual / activation outcomes for Compose primitives.
 *
...
/** Back-compat alias used by System/Status bar tests. */
internal fun gateAlpha(disposition: GateDisposition): Float = GateVisuals.alpha(disposition)
